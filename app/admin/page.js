      ...
      <div className="px-8 py-10 max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-10">
          <div>
            ...
            <h1 className="font-black uppercase text-4xl tracking-tight">Admin Panel</h1>
          </div>
          <motion.button
        ...
        >
          {statCards.map((s, i) => (
            ...
            >
              <s.icon size={14} style={{ color: s.color, opacity: 0.5 }} className="mb-4" />
              <div
                className="font-black mb-1"
                style={{ fontSize: '48px', lineHeight: 1, color: s.color, fontFamily: 'var(--font-syne)' }}
              >
                {s.value}
              </div>
              <div
              ...
              {messages.map((msg, i) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    <span
                      className="text-xs"
                      style={{ color: 'rgba(255,255,255,0.1)', fontFamily: 'var(--font-playfair)' }}
                    >
          ...
          {tab === 'ml' && (
            ...
            >
              <div
                ...
                style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)' }}
              >
                <div className="text-red-500 text-xs tracking-[0.3em] uppercase font-medium mb-6">
                  Pipeline Info
                </div>
                {[
                  ...
                  { label: 'Emergency Keywords', value: 'help, fire, danger, ambulance...' },
                  { label: 'Question Keywords', value: 'what, where, when, how, why...' },
                  { label: 'Fallback', value: 'Rule-based override < 70% confidence' },
                ].map((item, i) => (
                  <motion.div
                    key={item.label}
                    initial={{ opacity: 0, x: -10 }}
              ...
              >
                ...
                {[
                  ...
                  <div key={item.label} className="mb-8 last:mb-0">
                    <div className="flex justify-between text-xs mb-3">
                      <span style={{ color: item.color, fontFamily: 'var(--font-syne)', fontWeight: 700 }}>
                        {item.label}
                      </span>
                ...
                <div
                  ...
                  style={{ borderColor: 'rgba(255,255,255,0.04)' }}
                >
                  <div className="text-red-500 text-xs tracking-[0.3em] uppercase font-medium mb-4">
                    Model Status
                  </div>
                  {['Intent Classifier', 'Sentiment Analyzer', 'Urgency Scorer'].map((m, i) => (
                    <div key={m} className="flex items-center justify-between py-2">
                      <span className="text-white/40 text-xs" style={{ fontFamily: 'var(--font-playfair)' }}>
                        {m}
                      </span>
